* Demo
** TODO determine whether to focus on pvp or pve
* Features
** TODO elements
...
default behavior, just make all classes implement a base class.
*** TODO interfaces/type system?
It could be beneficial to have all actors implement an interface. This
would be checked using tests, not at runtime.
