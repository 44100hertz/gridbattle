...
return {
   -- Returns an array of strings representing the parts of a lua
   -- table containing anything other than functions. When printing,
   -- print a newline between each string for cleanliness.
   to_lua = function (tab, name)
      local strings = {}
